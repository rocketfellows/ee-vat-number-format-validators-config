# Estonia vat number format validators config

![Code Coverage Badge](./badge.svg)

This package provides a preconfigured configuration class for vat number format validators for Estonia country.
Is an extension of the package https://github.com/rocketfellows/specific-country-vat-number-format-validators-config.

## Installation

```shell
composer require rocketfellows/ee-vat-number-format-validators-config
```

## Dependencies

- https://github.com/rocketfellows/specific-country-vat-number-format-validators-config v1.0.0;
- https://github.com/rocketfellows/ee-vat-format-validator v1.0.0;
...
- **_rocketfellows\EEVatNumberFormatValidatorsConfig\EEVatNumberFormatValidatorsConfig_** - preconfigured configuration class for vat number format validators for Estonia country;

## EEVatNumberFormatValidatorsConfig description

A configuration class that provides a match for the vat number format validators for the country Estonia.

Class interface:
- **_getCountry_** - returns Estonia **_Country_** instance;
- **_getValidators_** - returns validators tuple

When initializing the default configuration, the **_getValidators_** function returns a tuple with a single validator - an instance of EEVatFormatValidator.

```php
$config = new EEVatNumberFormatValidatorsConfig();

$config->getCountry();      // returns Estonia Country instance
$config->getValidators();   // returns CountryVatFormatValidators with one item - instance of EEVatFormatValidator
```
...
$config = new EEVatNumberFormatValidatorsConfig($newDefaultValidator);  // initialize with new default validator
...
// default preconfigured validator by default - instance of EEVatFormatValidator
